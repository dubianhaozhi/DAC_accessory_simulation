# [Contact us｜ILII -Follow your heart- 公式ウェブサイト]フォーム用
#
use strict;
my %cf;
#┌─────────────────────────────────
...
# 送信先メールアドレス
$cf{mailto} = 'harada@dac-inc.co.jp';
#$cf{mailto} = 'dac@dac-inc.co.jp';
...
# メール件名（初期値）
$cf{subject} = '【Contact us】ILII公式サイトからお問い合わせメールがありました。';

# メール件名の外部指定
# → 複数のフォームメールで運用する場合、タグで件名指定する
$cf{multi_sub} = {
	1 => '【Contact us】ILII公式サイトからお問い合わせメールがありました。',
	};

# 返信向けメールタイトル
$cf{sub_reply} = '【ILIIサイト】お問い合わせ誠にありがとうございます。';
